...
function Post_XeCo() {
  ...
  function CreatePost() {
    const [newPost, setNewPost] = useState({
        ...
        description: '',
        price: '',
        category: 'Do gia dung', // Changed to household items
        location: '',
        household: {
            name: '', // Product name
            origin: '', // Origin
    ...
    return (
        <>
            <Box sx={{ padding: 2 }}>
                <Typography variant='h6' style={{ fontWeight: 'bold' }} align='left' color='#000000'> Hình ảnh đồ gia dụng</Typography>
            ...
            <Box component="form" onSubmit={handleSubmit} sx={{ flexGrow: 1, padding: 2 }}>
                <Typography variant='h6' style={{ fontWeight: 'bold', marginBottom: 10 }} align='left' color='#000000'>
                    Thông tin đồ gia dụng
                </Typography>
                {[
                    { label: 'Tên sản phẩm', name: 'name', required: true },
                    { label: 'Xuất xứ', name: 'origin', required: true },
