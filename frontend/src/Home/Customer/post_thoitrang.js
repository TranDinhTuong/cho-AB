...
function Post_XeCo() {
  ...
  function CreatePost() {
    const [newPost, setNewPost] = useState({
        ...
        description: '',
        price: '',
        category: 'Thoi trang', // Changed category to "Thoi trang"
        location: '',
        fashion: {
            name: '', // Product name
            type: '', // Type of product (e.g., "nam", "nữ")
    ...
    return (
        <>
            <Box sx={{ padding: 2 }}>
                <Typography variant='h6' style={{ fontWeight: 'bold' }} align='left' color='#000000'> Hình ảnh thời trang</Typography>
            ...
            <Box component="form" onSubmit={handleSubmit} sx={{ flexGrow: 1, padding: 2 }}>
                ...
                {[
                    ...
                    { label: 'Loại sản phẩm', name: 'type', required: true }, // Type of product
