...
function Post_XeCo() {
  ...
  function CreatePost() {
      const [newPost, setNewPost] = useState({
          ...
          description: '',
          price: '',
          category: 'Sach', // Changed category to "Sach"
          location: '',
          book: {
              name: '', // Book title
              origin: '', // Publisher
              type: '', // Type of book (e.g., mystery, children)
              year: '', // Year of publication
              status: '', // Condition (new or used)
          },
      });
      ...
      return (
          <>
              <Box sx={{ padding: 2 }}>
                  <Typography variant='h6' style={{ fontWeight: 'bold' }} align='left' color='#000000'> Hình ảnh sách</Typography>
              ...
              <Box component="form" onSubmit={handleSubmit} sx={{ flexGrow: 1, padding: 2 }}>
                  ...
                  {[
                      { label: 'Tên sách', name: 'name', required: true },
                      { label: 'Nhà xuất bản', name: 'origin', required: true }, // Publisher
                      { label: 'Loại sách', name: 'type', required: true }, // Type of book
                      { label: 'Năm xuất bản', name: 'year', required: true }, // Year of publication
                      { label: 'Tình trạng', name: 'status', required: true },
