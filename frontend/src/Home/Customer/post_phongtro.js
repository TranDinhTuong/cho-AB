...
function Post_PhongTro() {
  ...
  function CreatePost() {
    const [newPost, setNewPost] = useState({
        ...
        description: '',
        price: '',
        category: 'Phong tro', // Changed category to "Phong tro"
        location: '',
        motel: {
            area: '', // Updated to match JSON structure
            deposit: '', // Updated to match JSON structure
        },
    });
    ...
    return (
        <>
            <Box sx={{ padding: 2 }}>
                <Typography variant='h6' style={{ fontWeight: 'bold' }} align='left' color='#000000'> Hình ảnh phòng trọ</Typography>
            ...
            <Box component="form" onSubmit={handleSubmit} sx={{ flexGrow: 1, padding: 2 }}>
                ...
                {[
                    { label: 'Diện tích', name: 'area', required: true },
                    { label: 'Tiền cọc', name: 'deposit', required: true },
